...
const ProfilePage = () => {
  ...
  const getUerDetails = async () => {
    try {
      ...
      console.log("Error: ", error.message)
      toast.error("Something wrong while fetch user details")
    }
  }
